document.addEventListener('DOMContentLoaded', function () {
    ...
    // Append shuffled elements back to their parent
...
function changeColors() {
    ...
    document.body.style.color = '#fff';               // New text color

    // Revert to original colors after 10 seconds
    setTimeout(function() {
        document.body.style.backgroundColor = '#fff';  // Original background color
        document.body.style.color = '#333';               // Original text color
